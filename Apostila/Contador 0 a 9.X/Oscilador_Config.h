 ...
 *                            Valor em MHz.
 */
#define _SISTEMA_USA_OSCILADOR_PRIMARIO                 Nao
#define _OSC_PRIMARIO_TIPO                              _XTAL_HS_MP
#define _OSC_PRIMARIO_FREQUENCIA                        8000000



/*  3. Oscilador Interno - Habilitação, Frequencia
 * 
...
/*  2. Oscilador Secundário - Habilitação e frequencia
 * 
 ...
 *                              Valor em KHz.
 */
#define _SISTEMA_USA_OSCILADOR_SECUNDARIO               Nao
 ...
 */
#define _OSC_PRIMARIO_PLL_ATIVADO                       Sim
